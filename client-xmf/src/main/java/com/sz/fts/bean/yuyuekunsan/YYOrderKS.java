...
public class YYOrderKS implements Serializable {
    ...
    private String jubenUser;

    private String jubenCompany;

    public String getJubenUser() {
        return jubenUser;
    }

    public void setJubenUser(String jubenUser) {
        this.jubenUser = jubenUser;
    }

    public String getJubenCompany() {
        return jubenCompany;
    }

    public void setJubenCompany(String jubenCompany) {
        this.jubenCompany = jubenCompany;
    }
