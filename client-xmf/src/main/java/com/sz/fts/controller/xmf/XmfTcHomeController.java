...
///**
// * @author 征华兴
// * @date 下午 2:37  2018/4/13 0013
// * @Copyright 江苏鸿信系统集成有限公司 All rights reserved
// */
//@Controller
//@RequestMapping(value = "/com/plaftorm/xmfTc")
//public class XmfTcHomeController extends BaseRquestAndResponse {
//
//    @Autowired
...
//                switch (method) {
//                    case "list":
//                        outcome = this.xmfService.taoCanList(params.toString());
//                        break;
////                    case "add":
////                        outcome = this.xmfService.addTaoCan(params.toString());
////                        break;
////                    case "delete":
////                        outcome = this.xmfService.deleteTaocan(params.toString());
////                        break;
//                    case "update":
//                        outcome = this.xmfService.updateTaoCan(params.toString());
//                        break;
//                }
//            } else {
