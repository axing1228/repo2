...
// */
//@Controller
//@RequestMapping(value = "/com/plaftorm/xmfOrder")
//public class XmfOrderHomeController extends BaseRquestAndResponse {
//
//    @Autowired
...
//                switch (method) {
//                    case "list":
//                        outcome = this.xmfService.orderList(params.toString());
//                        break;
//                     case "disable":
//                        outcome = this.xmfService.successOrder(params.toString());
//                        break;
////                    case "update":
