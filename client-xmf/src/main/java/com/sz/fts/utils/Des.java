 ...
 */
public class Des {
	// private static String KEY_1 = "_p$_";//_p$_
	// private static String KEY_2 = "$e%_";//$e%_
	// private static String KEY_3 = "";//thirdZth5keyEnK
	...
	* @version 1.0v
	...
	public static void main(String[] args) {
		Des des = new Des();
		System.out.println(des.strDec("#2345#$4234", "_p$_", "$TR%_", "wplatform"));
	}
